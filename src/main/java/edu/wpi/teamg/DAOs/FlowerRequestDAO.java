...
public class FlowerRequestDAO implements DAO {
  ...
  public HashMap<Integer, FlowerRequest> getAll() throws SQLException {
    ...
    ResultSet rs = null;
    SQL_flowerRequest =
        "select * from iteration4_presentation.request join iteration4_presentation.flowerrequest on iteration4_presentation.request.reqid = iteration4_presentation.flowerrequest.reqid";
    try {
