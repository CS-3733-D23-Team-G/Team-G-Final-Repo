...
public class MealRequestDAO implements DAO {
  ...
  public HashMap<Integer, MealRequest> getAll() throws SQLException {
    ...
    SQL_mealRequest =
        "select * from iteration4.request join iteration4.mealrequest on iteration4.request.reqid = iteration4.mealrequest.reqid";
  ...
  public void delete(Object obj) throws SQLException {
    ...
    String SQL_request = "delete from iteration4.request where reqId = ?";
