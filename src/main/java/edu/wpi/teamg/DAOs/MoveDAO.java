...
public class MoveDAO implements LocationMoveDao {
  ...
  public List getAll() throws SQLException {
    ...
    sql = "select * from teamgdb.iteration3.move";
  ...
  public void update(Object obj, String colName, Object value) {
    ...
    PreparedStatement ps;
    sql =
        "update teamgdb.iteration3.move set "
            + colName
  ...
  public void insert(Object obj) throws SQLException {
    ...
    sql = "INSERT INTO teamgdb.iteration3.move (nodeid, longname, date) VALUES (?,?,?);";
  ...
  public void exportCSV() throws SQLException, IOException {
    ...
    String sql = "select * from teamgdb.iteration3.move";
    ResultSet rs = null;
