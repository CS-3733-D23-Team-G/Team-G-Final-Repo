...
create table iteration1.Edge(
                                        ...
                                        foreign key (startNode) references teamgdb.iteration1.node(nodeID) ON DELETE CASCADE ON UPDATE CASCADE,
...
create table iteration1.Move(
                                        ...
                                        foreign key (nodeID) references teamgdb.iteration1.node(nodeID) ON DELETE CASCADE ON UPDATE CASCADE,
                                        foreign key (longName) references teamgdb.iteration1.LocationName(longName) ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table iteration1.Request (
                                            ...
                                            requestTime time,
                                            foreign key (empID) references teamgdb.iteration1.Employee(empID) ON DELETE CASCADE ON UPDATE CASCADE,
                                            foreign key (location) references teamgdb.iteration1.node(nodeID) ON DELETE CASCADE ON UPDATE CASCADE,
                                            foreign key (serveBy) references teamgdb.iteration1.Employee(empID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
INSERT INTO teamgdb.iteration1.request (reqID, empID, location, serveBy, status, requestDate, requestTime)
VALUES
...
INSERT INTO teamgdb.iteration1.mealrequest (reqID, recipient, mealOrder, note)
VALUES
...
INSERT INTO teamgdb.iteration1.ConferenceRoomRequest (reqID, endTime, purpose)
VALUES
...
INSERT INTO teamgdb.iteration1.FlowerRequest (reqID, flowerType, numFlower, recipient, note)
VALUES
