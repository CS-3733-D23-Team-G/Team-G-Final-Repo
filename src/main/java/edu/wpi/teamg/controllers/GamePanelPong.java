...
public class GamePanelPong extends JPanel implements Runnable {
  ...
  Graphics graphics;
  Random random;
  GamePongPaddle paddle1;
  GamePongPaddle paddle2;
  GamePongBall ball;
  GamePongScore score;
  ...
  GamePanelPong() {
    newPaddles();
    newBall();
    score = new GamePongScore(GAME_WIDTH, GAME_HEIGHT);
  ...
  public void newBall() {
    ...
    // Set Y to this if you want ball to always start from center: (GAME_HEIGHT / 2) -
    // (BALL_DIAMETER / 2)
  }
