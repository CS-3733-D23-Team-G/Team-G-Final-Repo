  ...
  public void testGetAllFlowerRequest() throws SQLException {
   ...
   assertEquals(flowerRequestHash,allFlowers);
    ...
    public void testGetAllRequest() throws SQLException {
        ...
        Request r1 = new Request(1, 3, "Conference Room", status1, "Paul",new java.util.Date(2023,02,05),new Time(12,0,0));

        requestHash.put(1,r1);
        requestHash.put(2,new Request(2,3,"Conference Room","Paul","done",new java.sql.Date(2023,02,05), new Time(12,0,0)));
        requestHash.put(3,new Request(3,3,"Conference Room","Paul","done",new java.sql.Date(2023,02,05), new Time(12,0,0)));
