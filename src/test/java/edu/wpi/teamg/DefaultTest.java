...
//    Request r1 =
//        new Request(
//            "", "", "Conference Room", status1, "Paul", new Date(2023, 2, 5), new Time(12, 0, 0));
//
//    StatusTypeEnum status2 = StatusTypeEnum.valueOf("in progress");
//    Request r2 =
//        new Request("", "", "Patient Room", status2, "Mary", new Date(2023, 2, 5), new Time(2, 0, 0));
//
//    StatusTypeEnum status3 = StatusTypeEnum.valueOf("done");
//    Request r3 =
//        new Request(
//                "", "", "Main Office", status3, "Austin", new Date(2023, 2, 5), new Time(4, 0, 0));
//
...
//    StatusTypeEnum status2 = StatusTypeEnum.valueOf("in progress");
//    Request r2 =
//        new Request(2, 2, "Patient Room", status2, "Mary", new Date(2023, 2, 5), new Time(2, 0, 0));
//
//    StatusTypeEnum status3 = StatusTypeEnum.valueOf("done");
//    Request r3 =
//        new Request(
